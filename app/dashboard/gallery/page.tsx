  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto w-full">
      ...
      {restoredData?.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 px-4 text-center bg-white/[0.02] backdrop-blur-md border border-white/10 rounded-2xl border-dashed">
          ...
          <Link
            href="/dashboard"
            className="bg-red-brand hover:bg-red-brand-light text-neutral-50 px-6 py-2 rounded-lg font-medium transition-colors"
          >
            Go to Dashboard
          </Link>
        </div>
          ...
          {restoredData?.map((item) => {
            ...
            return (
              <div key={item.id} className="flex flex-col gap-2">
                ...
                <div className="px-1 text-xs font-medium text-neutral-400 flex justify-between items-center">
